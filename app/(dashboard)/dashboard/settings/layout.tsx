...
export default function DashboardLayout({
  ...
  return (
    <div className="flex flex-col min-h-[calc(100dvh-68px)] max-w-[1600px] mx-auto w-full lg:px-4">
      {/* Mobile header */}
      ...
      <div className="flex flex-1 overflow-hidden h-full">
        {/* Sidebar */}
        <aside
          className={`w-64 bg-background lg:bg-background border-r border-border lg:block ${
